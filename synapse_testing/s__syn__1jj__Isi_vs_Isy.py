...
sim_params['dt'] = dt
sim_params['tf'] = tf
sim_params['synapse_model'] = 'lookup_table' # 'ode' #
...
for ii in range(num_files): # range(1): # 
    ...
    synapse_1 = synapse('sy', num_jjs = num_jjs, integration_loop_temporal_form = 'exponential', 
                        integration_loop_time_constant = tau_si, integration_loop_self_inductance = L_si, synaptic_bias_currents = [20e-6,I_sy_vec[ii]], 
                        integration_loop_output_inductance = 0e-12, input_signal_name = 'in', 
