...
for ii in range(num_files): # range(1): # 
    ...
    # initialize synapse    
    synapse_1 = synapse('sy', num_jjs = 2, integration_loop_temporal_form = 'exponential', integration_loop_time_constant = tau_si, 
                        integration_loop_self_inductance = L_si, integration_loop_output_inductance = 0e-12, 
                        synaptic_bias_currents = [I_spd,I_sy_vec[ii],I_sc], integration_loop_bias_current = I_sc,
...
for ii in range(num_files):
    ...
    synapse_1 = synapse('sy', num_jjs = 2, integration_loop_temporal_form = 'exponential', integration_loop_time_constant = tau_si, 
                        ...
                        synaptic_bias_currents = [I_spd,I_sy,I_sc], integration_loop_bias_current = I_sc,
                        input_signal_name = 'in', synapse_model_params = sim_params)
...
if 1 == 2:
    ...
    for ii in range(num_files): # range(1): # 
        ...
        synapse_1 = synapse('sy', num_jjs = 2, integration_loop_temporal_form = 'exponential', integration_loop_time_constant = tau_si, 
                            integration_loop_self_inductance = L_si, integration_loop_output_inductance = 0e-12, 
                            synaptic_bias_currents = [I_spd,1e-6*I_sy_vec[ii],I_sc], integration_loop_bias_current = I_sc,
                            input_signal_name = 'in', synapse_model_params = sim_params)
