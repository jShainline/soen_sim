...
for qq in range(len(dt_vec)): 
    ...
    for ii in range(num_files):
        ...
        # plot_wr_comparison__synapse(data_file_list[ii],spike_times,target_drive,actual_drive,target_data,actual_data,data_file_list[ii],error_drive,error_signal)
