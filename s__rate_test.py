...
rate_vec = np.linspace(2e5,20e6,100)#np.array([1e6])#np.logspace(np.log10(2e5),np.log10(2e7),3)#
...
ax.set_ylabel(r'Output rate [MHz]', fontsize = axes_labels_font_size)
