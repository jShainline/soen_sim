...
for ii in range(num_drives):
    ...
    file_name = 'syn_2jj_cnst_drv_Isy{:5.2f}uA_Isc{:5.2f}uA_Idrv{:05.2f}uA_Ldi0077.50nH_taudi0077.5ms_dt00.10ps.dat'.format(I_sy,I_sc,I_drive_list[ii])
...
cbar.minorticks_on()     
fig.suptitle('Rate [kilofluxons per $\mu$s] (2-jj synapse)')
...
save_string = 'master__syn__rate_array__2jj__Isipad{:04.0f}nA'.format(I_si_pad*1e9)
data_array = dict()
