...
for ii in range(num_files): # range(1): # 
    ...
    #load WR data
    file_name = 'syn_2jj_Ispd20.00uA_trep50ns_Isy{:04.2f}uA_Isc35.00uA_Lsi{:07.2f}nH_tausi{:04.0f}ns_dt10.0ps_tsim1000ns.dat'.format(I_sy_vec[ii]*1e6,L_si_vec[ii]*1e9,tau_si_vec[ii]*1e9)
    ...
    synapse_1 = synapse('sy', num_jjs = 2, integration_loop_temporal_form = 'exponential', integration_loop_time_constant = tau_si_vec[ii], 
                        ...
                        synaptic_bias_currents = [I_spd,I_sy_vec[ii],I_sc], input_signal_name = 'in', synapse_model_params = sim_params)
