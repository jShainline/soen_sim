...
from _plotting import plot_receiving_loop_current, plot_rate_vs_num_active_synapses, plot_synaptic_integration_loop_current, plot_neuronal_response__single_synaptic_pulse, plot_burst_size_vs_num_active_synapses, plot_dendritic_integration_loop_current
...
input_2 = input_signal('input_dendritic_drive', input_temporal_form = 'analog_dendritic_drive', output_inductance = 200e-12, 
                       time_vec = np.arange(0,20e-9+dt,dt), amplitude = 20e-6, time_on = 2e-9)  
