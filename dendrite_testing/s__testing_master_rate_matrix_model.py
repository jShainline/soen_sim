...
from _functions import read_wr_data, chi_squared_error, dendritic_drive__piecewise_linear, dendritic_drive__exp_pls_train__LR
from soen_sim import input_signal, synapse, dendrite, neuron

#%% load wr for constant drive
...
#%% load wr for exp pulse seq
# file_name = 'dend_exp_pls_seq_Idrv23.00uA_Ldi0077.50nH_taudi0775ms_tsim0200ns_dt01.0ps.dat'
# file_name = 'dend_exp_pls_seq_Idrv23.00uA_Ldi0775.00nH_taudi7750ms_tsim0200ns_dt01.0ps.dat'
# file_name = 'dend_exp_pls_seq_Idrv23.00uA_Ldi0077.50nH_taudi007.75ns_tsim0200ns_dt01.0ps.dat'
file_name = 'dend_exp_pls_seq_Idrv23.00uA_Ldi0775.00nH_taudi077.5ns_tsim0200ns_dt01.0ps.dat'
data_dict = read_wr_data('wrspice_data/test_data/'+file_name)
