...
amp_vec = np.linspace(10,20,3) # np.logspace(np.log10(7),np.log10(200),num_loop)#np.linspace(25,25,1)#np.linspace(25,25,1)#
mu1_vec = np.linspace(1,2.5,num_loop)
mu2_vec = np.linspace(0.25,1,num_loop)
mu3_vec = np.linspace(0.5,1.5,num_loop)
mu4_vec = np.linspace(0.25,1,num_loop)
