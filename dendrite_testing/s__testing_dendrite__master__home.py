...
data_set = 'minimal' #'minimal' #'intermediate' #'all'

num_loop = 1

mu1_vec = np.linspace(2,3,num_loop)
mu2_vec = np.linspace(0.5,1,num_loop)
...
t_tot = time.time()        
best_params__no_leak__vary_Ldi, error_mat_master__mu1_mu2__no_leak__vary_Ldi = dendrite_model__parameter_sweep(data_file_list,L_di_vec,tau_di_vec,dt_vec,tf_vec,drive_info,mu1_vec,mu2_vec,master_error_plot_name)
...
#call main sweep function 
t_tot = time.time()        
best_params__vary_taudi, error_mat_master__mu1_mu2__vary_taudi = dendrite_model__parameter_sweep(data_file_list,L_di_vec,tau_di_vec,dt_vec,tf_vec,drive_info,mu1_vec,mu2_vec,master_error_plot_name)
elapsed = time.time() - t_tot
...
#call main sweep function 
t_tot = time.time()        
best_params__vary_Idrive_20uA, error_mat_master__mu1_mu2__vary_Idrive_20uA = dendrite_model__parameter_sweep(data_file_list,L_di_vec,tau_di_vec,dt_vec,tf_vec,drive_info,mu1_vec,mu2_vec,master_error_plot_name)
elapsed = time.time() - t_tot
...
#call main sweep function 
t_tot = time.time()        
best_params__vary_Idrive_25uA, error_mat_master__mu1_mu2__vary_Idrive_25uA = dendrite_model__parameter_sweep(data_file_list,L_di_vec,tau_di_vec,dt_vec,tf_vec,drive_info,mu1_vec,mu2_vec,master_error_plot_name)
elapsed = time.time() - t_tot
...
#call main sweep function 
t_tot = time.time()        
best_params__vary_Idrive_30uA, error_mat_master__mu1_mu2__vary_Idrive_30uA = dendrite_model__parameter_sweep(data_file_list,L_di_vec,tau_di_vec,dt_vec,tf_vec,drive_info,mu1_vec,mu2_vec,master_error_plot_name)
elapsed = time.time() - t_tot
...
#call main sweep function 
t_tot = time.time()        
best_params__lin_ramp, error_mat_master__mu1_mu2__lin_ramp = dendrite_model__parameter_sweep(data_file_list,L_di_vec,tau_di_vec,dt_vec,tf_vec,drive_info,mu1_vec,mu2_vec,master_error_plot_name)
elapsed = time.time() - t_tot
...
#call main sweep function 
t_tot = time.time()        
best_params__sq_pls_trn_per20ns, error_mat_master__mu1_mu2__sq_pls_trn_per20ns = dendrite_model__parameter_sweep(data_file_list,L_di_vec,tau_di_vec,dt_vec,tf_vec,drive_info,mu1_vec,mu2_vec,master_error_plot_name)
elapsed = time.time() - t_tot
...
#call main sweep function 
t_tot = time.time()        
best_params__exp_pls_trn_per100ns, error_mat_master__mu1_mu2__exp_pls_trn_per100ns = dendrite_model__parameter_sweep(data_file_list,L_di_vec,tau_di_vec,dt_vec,tf_vec,drive_info,mu1_vec,mu2_vec,master_error_plot_name)
elapsed = time.time() - t_tot
...
title_string = '{}; mu1_best = {:1.2f}, mu2_best = {:1.2f}'.format(pre_str,mu1_best,mu2_best)    
