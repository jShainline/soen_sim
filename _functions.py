...
def neuron_time_stepper(neuron_object):
    ...
    for sy_name in n.input_synaptic_connections:
        ...
        _temp_str_2 = '{:1d}jj_Llft{:05.2f}_Lrgt{:05.2f}_Ide{:05.2f}'.format(n.synapses[sy_name].num_jjs,n.dendrites['{}__d'.format(sy_name)].L_left,n.dendrites['{}__d'.format(sy_name)].L_right,n.synapses[sy_name].bias_currents[0])
    ...
    for de_name in n.input_dendritic_connections:
        ...
        _temp_str_2 = '{:1d}jj_Llft{:05.2f}_Lrgt{:05.2f}_Ide{:05.2f}'.format(n.dendrites[de_name].num_jjs,n.dendrites[de_name].L_left,n.dendrites[de_name].L_right,n.dendrites[de_name].bias_currents[0])
        ...
        for de__sy_name in n.dendrites[de_name].input_synaptic_connections:
            ...
            #load all rate data to synapses 
            _temp_str_2 = '{:1d}jj_Llft{:05.2f}_Lrgt{:05.2f}_Ide{:05.2f}'.format(n.synapses[de__sy_name].num_jjs,n.synapses[de__sy_name].L_left,n.synapses[de__sy_name].L_right,n.synapses[de__sy_name].bias_currents[0])
    ...
    _temp_str_2 = '{:1d}jj_Llft{:05.2f}_Lrgt{:05.2f}_Ide{:05.2f}'.format(n.dendrites['{}__d'.format(n.name)].num_jjs,n.dendrites['{}__d'.format(n.name)].L_left,n.dendrites['{}__d'.format(n.name)].L_right,n.dendrites['{}__d'.format(n.name)].bias_currents[0])
