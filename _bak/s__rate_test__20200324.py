...
rate_vec = np.linspace(2e5,20e6,25)#np.array([1e6])#np.logspace(np.log10(2e5),np.log10(2e7),10)#[9.6e6]#
...
plot_save_string = 'I_sy={:2.2f}-{:02.2f}uA__tau_si={:04.2f}-{:04.2f}ns__tau_ref={:04.2f}-{:04.2f}ns__rate_in={:04.2f}-{:04.2f}MHz__dt={:04.2f}ns__obs={:04.2f}us__jitter={}ns'.format(1e6*I_sy_vec[0],1e6*I_sy_vec[-1],1e9*tau_si_vec[0],1e9*tau_si_vec[-1],1e9*tau_ref_vec[0],1e9*tau_ref_vec[-1],1e-6*rate_vec[0],1e-6*rate_vec[-1],1e9*dt,observation_duration*1e6,jitter_params[1])
