...
for ii in np.arange(4,num_Phi_p-7): # range(num_Phi_p):
    Phi_p = Phi_p_list[ii]        
    Ip = Phi_p_list[ii]/Mp
    
    file_name = 'master_dnd_rate_array_3jj_Ib{:06.2f}uA_Lp{:05.2f}pH_Ip{:09.6f}uA_Ldi0077.50nH_dt01.0ps_dsf400.soen'.format(Ib,Lp,Ip)
...
if do__squid_response == True:       
    ...
    ax_sq.set_xlim([0,0.4])   
    ax_sq.set_xlabel(r'$\Phi_{ex}/\Phi_0$')
