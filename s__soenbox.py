...
synapse_1 = synapse('test_synapse__exp', loop_temporal_form = 'exponential', 
                    time_constant = 200e-9, integration_loop_inductance = 10e-9, 
                    synaptic_bias_current = 33e-6, loop_bias_current = 31e-6)

synapse_2 = synapse('test_synapse__power_law', loop_temporal_form = 'power_law', 
